...
in
buildGoModule rec {
  inherit (sourceData.kubectl-rook-ceph) pname src;
  version = lib.strings.removePrefix "v" sourceData.kubectl-rook-ceph.version;

  vendorHash = "sha256-KOt8JghzEzg4e3zAOHSHTboqE+yQMPVUOOP/JS2+wJE=";
